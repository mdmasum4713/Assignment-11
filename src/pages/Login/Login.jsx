...
console.log('location in the login page', location)
	...
	const handleLogin = e =>{
        ...
        // get access token
        axios.post('https://assignment-11-server-side-gamma-steel.vercel.app/jwt', user,
    ...
    return (
        <div className="items-center justify-center">
      {
			user && <div className="text-center">
				...
				<img className="ml-auto mr-auto" src={user.photoURL} alt="" />
			</div>
		}
    <div className=" w-full lg:ml-96 md:ml-60  shadow-lg max-w-md p-8 space-y-3  rounded-xl dark:bg-gray-600 dark:text-gray-800">
        ...
        <form onSubmit={handleLogin}  noValidate="" action="" className="space-y-6">
         ...
         <input type={showPassword ? "text" : "password"}
            ...
            <button className="block w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-violet-600 bg-black text-white">Login</button>
        </form>
